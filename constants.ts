...
export const FRAME_AREA_THRESHOLD = 0.15; // Bbox should occupy at least 15% of frame area
export const CENTER_THRESHOLD = 0.15; // Bbox center should be within 15% of frame center
export const STABILITY_THRESHOLD = 10; // Number of consecutive valid frames to trigger capture